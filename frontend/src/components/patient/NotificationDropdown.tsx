...
/* Mock notifications */
const mockNotifications: PatientNotificationItem[] = [
  {
    id: "1",
    title: "Appointment confirmed",
    description:
      "Your cardiology appointment with Dr. Sarah Chen has been confirmed for tomorrow at 10:00 AM",
  ...
  },
  {
    ...
    description: "Your blood test results are now available in Lab Reports",
  ...
  },
  {
    ...
    description: "Your prescription for Amoxicillin is due for a refill",
  ...
  },
  {
    ...
    description:
      "You have a follow-up visit with Dr. Mitchell tomorrow at 2:30 PM",
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          !notif.read &&
                            "bg-[var(--color-primary)]/5 dark:bg-teal-950/20",
                        )}
