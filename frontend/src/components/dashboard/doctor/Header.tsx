...
export function Header() {
  const { toggleMobileSidebar, setCommandPaletteOpen } = useDoctorContext();

  return (
    <header
      className={cn(
        "sticky top-0 z-20 flex h-16 shrink-0 items-center gap-3 border-b border-slate-200/50 bg-white/70 backdrop-blur-xl px-4 lg:px-6",
    ...
    >
      ...
      <div className="hidden sm:block">
        <SearchBar onOpen={() => setCommandPaletteOpen(true)} />
      </div>
