...
export function DoctorsHero() {
  return (
    <section className="relative flex min-h-[70vh] items-center overflow-hidden pt-24 lg:min-h-[70vh] lg:pt-8">
      {/* Background image */}
      <Image
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-12 xl:gap-16">
          ...
          <div className="lg:col-span-7">
            ...
            <motion.div variants={itemVariants}>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/15 px-4 py-1.5 text-sm text-white backdrop-blur-sm">
                ...
                />
                <span>
                  <strong>50+ specialists</strong> across 15+ departments
                </span>
              </div>
            </motion.div>
            ...
            >
              Find experienced specialists dedicated to providing exceptional
              healthcare with compassion and expertise. Browse profiles, check
              availability, and book your appointment in minutes.
            </motion.p>
            ...
            >
              ...
              <Button className="text-white bg-accent/10" variant="outline" size="lg" href="/appointment">
          ...
          {/* Right column — empty on mobile, decorative on desktop */}
