    ...
    relatedEntities: [
      {
        ...
        id: "usr-012",
        name: "Dr. Williams",
        url: "/dashboard/admin/doctors/usr-012",
      },
    ],
    ...
    relatedEntities: [
      {
        ...
        id: "pat-042",
        name: "John Doe",
        url: "/dashboard/admin/patients/pat-042",
      },
    ],
    ...
    relatedEntities: [
      {
        ...
        url: "/dashboard/admin/appointments/APT-2025-0156",
      },
      {
        type: "Patient",
        id: "pat-015",
        name: "Jane Smith",
        url: "/dashboard/admin/patients/pat-015",
      },
    ],
    ...
    relatedEntities: [
      {
        ...
        id: "dept-015",
        name: "Pediatric Neurology",
        url: "/dashboard/admin/departments/dept-015",
      },
    ],
    ...
    relatedEntities: [
      {
        ...
        url: "/dashboard/admin/doctors/doc-023",
      },
    ],
  ...
  },
  {
    ...
    relatedEntities: [
      ...
      },
      {
        ...
        id: "pat-067",
        name: "Michael Brown",
        url: "/dashboard/admin/patients/pat-067",
      },
    ],
    metadata: {
    ...
    relatedEntities: [
      {
        ...
        id: "pat-023",
        name: "Robert Johnson",
        url: "/dashboard/admin/patients/pat-023",
      },
    ],
    metadata: {
    ...
    relatedEntities: [
      {
        ...
        id: "dept-007",
        name: "ICU",
        url: "/dashboard/admin/departments/dept-007",
      },
      {
        type: "User",
        id: "usr-004",
        name: "Maria Rodriguez",
        url: "/dashboard/admin/users/usr-004",
      },
    ],
    ...
    relatedEntities: [
      {
        ...
        id: "usr-028",
        name: "Lisa Thompson",
        url: "/dashboard/admin/users/usr-028",
      },
    ],
    metadata: {
  ...
  // 6 days ago
  {
    ...
    relatedEntities: [
      ...
      },
      {
        ...
        id: "doc-003",
        name: "Dr. Priya Sharma",
        url: "/dashboard/admin/doctors/doc-003",
      },
    ],
    metadata: {
    ...
    relatedEntities: [
      {
        ...
        url: "/dashboard/admin/doctors/doc-005",
      },
    ],
