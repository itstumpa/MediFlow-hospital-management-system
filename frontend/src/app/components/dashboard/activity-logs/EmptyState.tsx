      ...
      action={
        onCreateLog && (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={onCreateLog}
            className="inline-flex items-center gap-2 rounded-xl bg-dash-primary px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-dash-primary-dark hover:shadow-md"
          >
