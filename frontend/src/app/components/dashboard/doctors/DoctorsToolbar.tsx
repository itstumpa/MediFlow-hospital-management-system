    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-2 flex-wrap">
          ...
          <FilterChip
            label="Available"
            active={filters.availability.includes("Available")}
            onClick={() =>
              onFiltersChange({
                ...filters,
                availability: filters.availability.includes("Available")
      ...
      {selectedCount > 0 && (
        <motion.div
          ...
          className="text-sm font-medium text-dash-primary dark:text-accent"
        >
