...
import { fadeIn, fadeUp } from "@/components/dashboard/staff/MotionVariants";
import { PageHeader } from "@/components/dashboard/staff/PageHeader";
import { AnimatePresence, motion } from "framer-motion";
import { AlertTriangle, Plus, Search, UserPlus } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-900/50">
      <div className="p-4 md:p-6">
        <PageHeader
          ...
          subtitle="Register new patients and check in existing ones."
        >
          <Button
            variant="primary"
