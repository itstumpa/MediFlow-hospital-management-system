...
import { billingStats, formatCurrency, type BillingStat } from "../_mock-data";
...
function AnimatedCounter({
  ...
  return <>{isCurrency ? formatCurrency(count) : count.toLocaleString()}</>;
}
...
function StatCard({ stat, index }: { stat: BillingStat; index: number }) {
