          ...
          <motion.div variants={staggerItem} initial="hidden" animate="visible">
            <div className="flex items-center gap-3">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Search payments by invoice, patient, or doctor..."
                  value={searchQuery}
                          ...
                          {invoice.payments.length > 0 ? (
                            <div className="flex flex-wrap gap-1">
                              {invoice.payments.map((p) => {
                                const MethodIcon =
                                  methodIcons[p.method] || CreditCard;
                                return (
                                  <span
                                    key={p.id}
                                    className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-medium text-slate-600 dark:bg-slate-800 dark:text-slate-400"
                                  >
