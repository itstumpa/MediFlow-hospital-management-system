...
export function DepartmentFormSidebar() {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <ul className="mt-3 space-y-2">
          {[
            "Choose a distinctive icon and color for the department",
            "Fill in all required fields marked with *",
            "Add at least one doctor assignment",
            "Set accurate working hours for patients",
