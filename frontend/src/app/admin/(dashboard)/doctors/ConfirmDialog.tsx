...
> = {
  ...
  "save-draft": {
    ...
    confirmClass: "bg-blue-500 hover:bg-blue-600 focus-visible:outline-blue-500",
  },
  delete: {
    icon: Trash2,
    title: "Delete Doctor",
    description:
      "Are you sure you want to delete this doctor? This action cannot be undone. All associated data, appointments, and records will be permanently removed.",
    confirmLabel: "Delete",
    confirmClass: "bg-red-500 hover:bg-red-600 focus-visible:outline-red-500",
  },
};
          ...
          >
            ...
            <div className="mt-6 flex gap-3">
              ...
              <motion.button
                type="button"
                onClick={onConfirm}
                className={`flex-1 rounded-lg px-4 py-2.5 text-sm font-medium text-white transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 ${config.confirmClass}`}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                {config.confirmLabel}
