...
export const mockRoles: Role[] = [
  ...
  },
  {
    ...
    permissions: buildPermissionMap({
      ...
      Departments: somePermissions("View", "Create", "Update", "Delete", "Export", "Assign"),
      Appointments: somePermissions("View", "Create", "Update", "Delete", "Export", "Assign"),
      Articles: somePermissions("View", "Create", "Update", "Delete", "Approve"),
